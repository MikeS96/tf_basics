# -*- coding: utf-8 -*-
"""
Created on Mon Mar 26 22:24:14 2018
...
data=np.zeros([125,14],dtype=np.float64)
x_train=np.zeros([125,13],dtype=np.float64)
y_train=np.zeros([125,3],dtype=np.float64)
y_train_CM=np.zeros([125,1],dtype=np.float64)
Out_CM=np.zeros([125,1],dtype=np.float64)
...
Wco = tf.Variable(tf.random_uniform((13,15),-1,1), name='Wco')
bco = tf.Variable(tf.random_uniform((15,),-1,1), name='bco')

Wco1 = tf.Variable(tf.random_uniform((15,15),-1,1), name='Wco1')
bco1 = tf.Variable(tf.random_uniform((15,),-1,1), name='bco1')

Wco2 = tf.Variable(tf.random_uniform((15,10),-1,1), name='Wco2')
bco2 = tf.Variable(tf.random_uniform((10,),-1,1), name='bco2')
...
OutputCo1= tf.nn.relu(tf.matmul(OutputCo,Wco1)+bco1)
OutputCo2= tf.nn.relu(tf.matmul(OutputCo1,Wco2)+bco2)
Output=(tf.matmul(OutputCo2,Wcs)+bcs)
...
data2=np.zeros([53,14],dtype=np.float64)
x_test=np.zeros([53,13],dtype=np.float64)
y_test=np.zeros([53,3],dtype=np.float64)
y_test_CM=np.zeros([53,1],dtype=np.float64)
Out_test_CM=np.zeros([53,1],dtype=np.float64)
#Lectura de los datos de entrenamiento desde el archivo
cont=0;
