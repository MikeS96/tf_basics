...
DATA_TB = 'Train_AND' ##
#training Data
x_train = [[-0.5,-1],[1,1],[1,0.5],[-1,-0.5],[-1,-1],[0.5,1]]
y_train = [[0],[1],[1],[0],[0],[1]]
...
x = tf.placeholder(tf.float32,(6,2)) #Tamaño de los tensores de entrada
y = tf.placeholder(tf.float32,(6,1))
...
#Optimizer
optimizer = tf.train.GradientDescentOptimizer(0.001) #Learning rate de la red, utilizada en el gradiente descendiente
