...
x=tf.placeholder(tf.float32,(4,2)) #entrada de la red
y=tf.placeholder(tf.float32,(4,1)) #salida deseada de la red
...
writer = tf.summary.FileWriter("./log_TB/2",sess.graph)
