# -*- coding: utf-8 -*-
"""
Created on Fri May  4 02:43:26 2018
...
curr_loss, curr_Output = sess.run([lossCS,OutputCS], {X4 : np_OutputCo2, Y : data.test.labels})
...
print("Accuracy: ",sess.run(accuracy, feed_dict={X4: np_OutputCo2,Y: data.test.labels}))
