...
Wco = tf.Variable(tf.random_uniform((13,20),-1,1), name='Wco')
bco = tf.Variable(tf.random_uniform((20,),-1,1), name='bco')

Wcs = tf.Variable(tf.random_uniform((20,3),-1,1), name='Wcs')
