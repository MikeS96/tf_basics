# -*- coding: utf-8 -*-
"""
Created on Tue Mar 27 13:07:00 2018
...
Wcs = tf.Variable(tf.random_uniform((10,4),-1,1), name='Wcs')
...
sess = tf.Session()
#train_writer = tf.summary.FileWriter( "./Tu_Madre/Wey" , sess.graph) #Más pendejadas de Tensorboard
sess.run(init) 
