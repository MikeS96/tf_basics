...
OutputCo= tf.sigmoid(tf.matmul(X,Wco)+bco)
...
#optimizer = tf.train.RMSPropOptimizer(0.01,0.9,0.3,1e-10) #(0.001,0.9,0.3,1e-10) y con 0.01 da melo, 10000 epocas
...
#train_writer = tf.summary.FileWriter( "./Final_NON/0.01_0.9_10_2500" , sess.graph) #Más pendejadas de Tensorboard
